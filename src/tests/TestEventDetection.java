...
import models.Event;
import models.detection.DetectionEvent;
import models.detection.TargetGatherEvent;
import sim.Constants;
import sim.entity.DetectedEntity;
import sim.entity.Entity;

public class TestEventDetection extends TestEvent {

	protected static final String name = "TestEventDetection";
	...
	protected Event makeEvent(Entity entity){
		return new DetectionEvent(scenario.getParameters().getStartTime(), scenario, entity);		
	}

	public TestEventDetection(String[] args) {
		super(args);
	}

	public static void main(String[] args){
		TestEventDetection test = new TestEventDetection(args);
		if (args.length<=0){
